      ...
      <div className="justify-start items-center gap-8 flex">
        <div className="hidden rounded-[50px] border border-neutral-200 justify-start items-start md:flex">
          <div className="px-8 py-2.5 hover:bg-neutral-200 rounded-l-full duration-300 items-center gap-2 flex">
            ...
            <div className="text-zinc-900 texxt-base">Walk-In</div>
          </div>
          <div className="px-8 py-2.5 hover:bg-neutral-200 rounded-r-full border-l border-neutral-100 duration-300 items-center gap-2 flex">
            <div className="w-6 h-6 relative">
              <div className="h-5 left-[6px] top-0.5 absolute">
                <img src={dinein} alt="" />
              </div>
            </div>
            <div className="text-zinc-900 texxt-base">Dine-In</div>
          </div>
        </div>
